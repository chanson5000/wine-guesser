...
if (is_post_request()) {
    ...
    $guessed_wine_id = wine_guess_id(transform_wine_fields(sanitize_wine_fields($_POST, RED_WINE), RED_WINE), RED_WINE);

    redirect_to(url_for('/guess-red.php?id=' . u($guessed_wine_id)));
