    ...
    <form class="wine-form wine-table" action="guess.php" method="get">
        ...
        <table class="wine-char max-width">
            ...
            <tr>
                ...
                <td class="con-choice">Baked, Dried, Bruised<br><input type="checkbox" name="fruit-nose" value="baked"></td>
            </tr>
        </table>
        <table class="wine-char max-width">
            <tr>
            ...
            <tr>
                ...
                <td class="con-choice">Baked, Dried, Bruised<br><input type="checkbox" name="fruit-palate" value="baked"></td>
            </tr>
        </table>
        <table class="wine-char max-width">
            <tr>
