...
<div class="center">
    ...
    <form class="wine-form" action="<?php echo url_for('/admin/white-wine/new.php') ?>" id="wine-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td><label for="straw">Straw </label><input type="checkbox" name="straw" id="straw" value="1"></td>
                <td><label for="yellow">Yellow </label><input type="checkbox" name="yellow" id="yellow" value="1"></td>
                <td><label for="gold">Gold </label><input type="checkbox" name="gold" id="gold" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr>
                <td><label for="apple">Apple/Pear </label><input type="checkbox" name="apple" id="apple" value="1"></td>
                <td><label for="citrus">Citrus </label><input type="checkbox" name="citrus" id="citrus" value="1"></td>
                <td><label for="stone">Stone </label><input type="checkbox" name="stone" id="stone" value="1"></td>
                <td><label for="tropical">Tropical </label><input type="checkbox" name="tropical" id="tropical" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr>
                <td><label for="nose_tart">Tart</label><br><input type="checkbox" name="nose_tart" id="nose_tart" value="1"></td>
                <td><label for="nose_ripe">Ripe</label><br><input type="checkbox" name="nose_ripe" id="nose_ripe" value="1"></td>
                <td><label for="nose_overripe">Overripe, Jammy, Stewed</label><br><input type="checkbox" name="nose_overripe" id="nose_overripe" value="1"></td>
                <td><label for="nose_baked">Baked, Dried, Bruised</label><br><input type="checkbox" name="nose_baked" id="nose_baked" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr>
                <td><label for="palate_tart">Tart</label><br><input type="checkbox" name="palate_tart" id="palate_tart" value="1"></td>
                <td><label for="palate_ripe">Ripe</label><br><input type="checkbox" name="palate_ripe" id="palate_ripe" value="1"></td>
                <td><label for="palate_overripe">Overripe, Jammy, Stewed</label><br><input type="checkbox" name="palate_overripe" id="palate_overripe" value="1"></td>
                <td><label for="palate_baked">Baked, Dried, Bruised</label><br><input type="checkbox" name="palate_baked" id="palate_baked" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="checkbox" name="dry" id="sweetness" value="1"></td>
                <td><input type="checkbox" name="off_dry" id="sweetness" value="1"></td>
                <td><input type="checkbox" name="sweet" id="sweetness" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><input type="checkbox" name="acid_low" id="acid" value="1"></td>
                <td><input type="checkbox" name="acid_mod" id="acid" value="1"></td>
                <td><input type="checkbox" name="acid_mod_plus" id="acid" value="1"></td>
                <td><input type="checkbox" name="acid_high" id="acid" value="1"></td>
            </tr>
            <tr>
                <td class="left"><label for="alcohol">Alcohol:</label></td>
                <td><input type="checkbox" name="alcohol_low" id="alcohol" value="1"></td>
                <td><input type="checkbox" name="alcohol_mod" id="alcohol" value="1"></td>
                <td><input type="checkbox" name="alcohol_mod_plus" id="alcohol" value="1"></td>
                <td><input type="checkbox" name="alcohol_high" id="alcohol" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr>
                <td><label for="climate_cool">Cool </label><input type="checkbox" name="climate_cool" id="climate_cool" value="1"></td>
                <td><label for="climate_moderate">Moderate </label><input type="checkbox" name="climate_moderate" id="climate_moderate" value="1"></td>
                <td><label for="climate_warm">Warm </label><input type="checkbox" name="climate_warm" id="climate_warm" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr>
                <td colspan="3"><textarea class="max-width" name="description" id="description" cols="3" rows="3"></textarea></td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr>
                <td colspan="3"><textarea class="max-width" name="notes" id="notes" cols="3" rows="3"></textarea></td>
            </tr>
        </table>
        <table>
            <tr>
