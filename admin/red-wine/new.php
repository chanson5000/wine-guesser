...
if (is_post_request()) {
    ...
    $result = create_red_wine($wine);
    if($result === true) {
        $new_id = mysqli_insert_id($db);
        $_SESSION['message'] = 'Wine added.';
        redirect_to(url_for('admin/red-wine/view.php?id=' . $new_id));
    } else {
        $errors = $result;
    }
}
...
<div class="center">
    ...
    <form class="wine-form" action="<?php echo url_for('/admin/red-wine/new.php') ?>" id="wine-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td><label for="garnet">Garnet </label><input type="checkbox" name="garnet" id="garnet" value="1"></td>
                <td><label for="ruby">Ruby </label><input type="checkbox" name="ruby" id="ruby" value="1"></td>
                <td><label for="purple">Purple </label><input type="checkbox" name="purple" id="purple" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="checkbox" name="tannin_low" id="st-tannin" value="1"></td>
                <td><input type="checkbox" name="tannin_mod" id="st-tannin" value="1"></td>
                <td><input type="checkbox" name="tannin_mod_plus" id="st-tannin" value="1"></td>
                <td><input type="checkbox" name="tannin_high" id="st-tannin" value="1"></td>
            </tr>
            <tr>
                <td class="left"><label for="st-acid">Acid:</label></td>
                <td><input type="checkbox" name="acid_low" id="st-acid" value="1"></td>
                <td><input type="checkbox" name="acid_mod" id="st-acid" value="1"></td>
                <td><input type="checkbox" name="acid_mod_plus" id="st-acid" value="1"></td>
                <td><input type="checkbox" name="acid_high" id="st-acid" value="1"></td>
            </tr>
            <tr>
                <td class="left"><label for="st-alcohol">Alcohol:</label></td>
                <td><input type="checkbox" name="alcohol_low" id="st-alcohol" value="1"></td>
                <td><input type="checkbox" name="alcohol_mod" id="st-alcohol" value="1"></td>
                <td><input type="checkbox" name="alcohol_mod_plus" id="st-alcohol" value="1"></td>
                <td><input type="checkbox" name="alcohol_high" id="st-alcohol" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr>
                <td><label for="climate-cool">Cool </label><input type="checkbox" name="climate_cool" id="climate-cool" value="1"></td>
                <td><label for="climate-moderate">Moderate </label><input type="checkbox" name="climate_moderate" id="climate-moderate" value="1"></td>
                <td><label for="climate-warm">Warm </label><input type="checkbox" name="climate_warm" id="climate-warm" value="1"></td>
            </tr>
        </table>
        <table>
            <tr>
